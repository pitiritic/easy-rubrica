...
- **Identificación en PDF:** Incorporación dinámica del nombre del Alumno y el nombre de la Rúbrica en la cabecera de los detalles de evaluación para una identificación clara en archivos exportados.
- **Sistema de Colores por Tipo:** Implementación de etiquetas inteligentes (badges) con códigos de color específicos: **Verde** para Autoevaluación, **Azul** para Coevaluación y **Rojo** para Heteroevaluación.
- **Detalle de Evaluador:** Integración del nombre del evaluador dentro del desglose de la rúbrica (modal y PDF).
- **Consistencia de Calificaciones:** Visualización de la nota final obtenida directamente en la cabecera del detalle evaluativo.
