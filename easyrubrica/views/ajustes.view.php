    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            <div class="card shadow-sm border-0 h-100 hover-card d-flex flex-column">
                ...
                <div class="card-body d-flex flex-column">
                    <p class="text-muted">Sube un archivo de respaldo previo para restaurar toda la información del sistema.</p>
            ...
            <div class="card shadow-sm border-0 hover-card">
                ...
                <div class="card-body">
                    <form method="POST">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="form-label fw-bold small text-muted">SERVIDOR SMTP</label>
                                <input type="text" name="smtp_host" class="form-control" value="<?= htmlspecialchars($smtp['smtp_host'] ?? '') ?>" required>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold small text-muted">USUARIO / EMAIL</label>
                            ...
                            <div class="col-md-2">
                                <label class="form-label fw-bold small text-muted">SEGURIDAD</label>
                            ...
                            <div class="col-md-4">
                                <label class="form-label fw-bold small text-muted">EMAIL REMITENTE</label>
                                <input type="email" name="from_email" class="form-control" value="<?= htmlspecialchars($smtp['from_email'] ?? '') ?>" required>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold small text-muted">NOMBRE REMITENTE</label>
