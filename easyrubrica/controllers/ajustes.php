...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['reset_total'])) {
        try {
            Audit::log($pdo, "Formateo de Sistema", "Borrado total de la base de datos.");
    ...
    if (isset($_POST['guardar_smtp'])) {
        try {
            // Actualización completa con todos los campos necesarios
            ...
            Audit::log($pdo, "Ajustes SMTP", "Se actualizó la configuración completa del correo.");
    ...
    if (isset($_POST['guardar_sistema'])) {
        try {
            ...
            Audit::log($pdo, "Ajustes Sistema", "Se actualizaron los enlaces de la plataforma.");
